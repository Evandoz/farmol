...
function centerDialog(dialogBox){
    $(dialogBox).show(0,function(){
        ...
        dialogHei = $(this).find('.modal-dialog').height();
        if(dialogHei + 100 < winHei){
            $(this).find('.modal-dialog').css('margin-top',(winHei-dialogHei)/2 + 'px');
        }else{
             $(this).find('.modal-dialog').css('margin-top','30px');
        }
    });
}

function topDialog(dialogBox){
    $(dialogBox).show(0,function(){
        $(this).find('.modal-dialog').css('margin-top',0 + 'px');
    });
}
...
var Dml = {};
    Dml.fun = {
        ...
        showTipsDialog: function(obj){
            ...
            //$Box.find('p').html(p);
            if(type){
                $Box.find('.fa').removeClass('fa-check-circle').addClass('fa-info-circle');
                topDialog($Box);
            }else{
                topDialog($Box);
            }
